...
class DatabaseConn {	
  ...
  public function dbOpen(){
    ...
    try {
      ...
      $dbHost = 'localhost';
      $dbName = 'bjpetroski';//this will be your WCC username
      $dbUsr = 'bjpetroski';//this will be your WCC username
      $dbPass = 'VewyDhvdrgF2';//this will be the password found in the video.
