...
$name = "Brenden Petroski";
$mainText = "";
$i = 0;

while($i<3){
    $mainText .= "<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                    ...
                    Nullam in euismod nisl. Donec pulvinar ex sit amet aliquet egestas.</p>";
    $mainText .= "<br>";
    $i++;
}
